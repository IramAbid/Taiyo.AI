...
<h2 className="text-xl sm:text-3xl font-semibold mb-2 sm:mb-8 text-center"><span className='text-orange-800'>Geographical Visualization:</span> Mapping Active, Deceased and Recovered Cases Around the World</h2>
